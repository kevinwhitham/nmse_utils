def get_nmse_structure(structure_numbers):
    """
    ...
    nmse_data = pd.read_json('nmse_database/nmse_data_frame.json')
...
def load_atoms_from_cif(structure_file_name):
...
def filter_structures(database, general_filters, compound_filters):
    """
